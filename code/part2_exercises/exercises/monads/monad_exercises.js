...
// Exercise 1 ========== Use safeProp and map/join or chain to safely get the
// street name when given a user
...
// Exercise 2 ========== Use getFile to get the filename, remove the directory
// so it's just the file, then purely log it.
...
// Exercise 3 ========== Use getPost() then pass the post's id to getComments().
...
// Exercise 4 ========== Use validateEmail, addToMailingList and emailBlast to
// implement ex4's type signature. It should safely add a new subscriber to the
// list, then email everyone with this happy news.  addToMailingList :: Email ->
// IO [Email]
